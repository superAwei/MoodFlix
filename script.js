...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function analyzeMood(description) {
        const moodKeywords = {
            ...
            '放鬆': ['放鬆', '平靜', '安寧', '舒適', '輕鬆', '悠閒', '愜意', '自在', '舒坦', '舒服', '舒心', '舒暢', '舒緩', '舒展', '舒適', '舒適自在', '舒適愜���', '舒適安逸', '舒適寧靜', '舒適恬靜', '舒適恬淡', '舒適恬適', '舒適恬逸', '舒適恬然', '舒適恬淡', '舒適恬靜', '舒適恬逸', '舒適恬然', '舒適恬淡', '舒適恬靜', '舒適恬逸', '舒適恬然', '舒適恬淡', '舒適恬靜', '舒適恬逸', '舒適恬然', '舒適恬淡', '舒適恬靜', '舒適恬逸', '舒適恬然', '舒適恬淡', '舒適恬靜', '舒適恬逸', '舒適恬然', '舒適恬淡', '舒適恬靜', '舒適恬逸', '舒適恬然'],
            ...
            '浪漫': ['浪漫', '戀愛', '甜蜜', '溫馨', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調', '浪漫情懷', '浪漫情調'],
            ...
            '興奮': ['興奮', '激動', '亢奮', '熱血', '興高采烈', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃', '興致盎然', '興致勃勃'],
